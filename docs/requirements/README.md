...
| :----------------------------------------------------- | :---------------------- | :--------------------------------------------------------------------------------------------------------------------- |
| [`PRODUCT_REQUIREMENTS.md`](./PRODUCT_REQUIREMENTS.md) | Draft — awaiting review | What the system must do, traced to the coding challenge specification. Records ambiguities rather than resolving them. |
